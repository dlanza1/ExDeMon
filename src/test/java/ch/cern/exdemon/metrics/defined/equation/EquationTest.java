...
public class EquationTest {
	...
	public void evalWithVariables() throws ParseException, ConfigurationException {
		...
		valHistory1.add(time, new FloatValue(3), null);	
		...
		valHistory1.add(time, new FloatValue(5), null);
		valHistory2.add(time, new FloatValue(10), null);
		...
		valHistory1.add(time, new StringValue("/tmp/"), null);
		valHistory2.add(time, new FloatValue(10), null);
		...
		valHistoryX.add(time, new FloatValue(5), null);
		valHistoryY.add(time, new StringValue("10"), null);
		...
		valHistoryX.add(time, new FloatValue(5), null);
        valHistoryY.add(time, new FloatValue(10), null);
		valHistory1.add(time, new FloatValue(10), null);
		assertEquals(105f, new Equation("x+y * (var1)", props).compute(stores, time).getAsFloat().get(), 0.000f);
		
		valHistoryX.add(time, new FloatValue(5), null);
        valHistoryY.add(time, new FloatValue(10), null);
		valHistory1.add(time, new BooleanValue(true), null);
		valHistory2.add(time, new BooleanValue(false), null);
		...
		String inputToConcat1 = "aa";
		String inputToConcat2 = "bb";
		valHistory1.add(time, new StringValue(inputToConcat1), null);
		valHistory2.add(time, new StringValue(inputToConcat2), null);
	...
	public void evalWithVariablesAndFormulas() throws ParseException, ConfigurationException {
		...
		valHistoryX.add(time, new FloatValue(9), null);
		assertEquals(9f, new Equation("abs(x)", props).compute(stores, time).getAsFloat().get(), 0.01f);
		valHistoryX.add(time, new FloatValue(-9), null);
		assertEquals(9f, new Equation("abs(x)", props).compute(stores, time).getAsFloat().get(), 0.01f);
		
		valHistoryX.add(time, new FloatValue(10), null);
		...
		valHistoryX.add(time, new FloatValue(10), null);
		valHistoryY.add(time, new FloatValue(2), null);
