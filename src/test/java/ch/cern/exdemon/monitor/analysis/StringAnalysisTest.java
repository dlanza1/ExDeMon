...
public class StringAnalysisTest {
	...
	private StringAnalysis analysis = new StringAnalysis() {
										private static final long serialVersionUID = 2630885101669119453L;
								
										@Override
										public AnalysisResult process(Instant timestamp, String value) {
	...
	public void shouldAnalyzeOnlyStringMetric() {		
		...
		assertEquals(Status.EXCEPTION, analysis.apply(new Metric(Instant.now(), new BooleanValue(true), null)).getStatus());
	}
