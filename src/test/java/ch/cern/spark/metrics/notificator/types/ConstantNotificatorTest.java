...
public class ConstantNotificatorTest {
    ...
    public void raise() throws Exception{
        ...
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:04:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:05:00")));
        ...
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:10:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:11:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:12:00")));
        assertNotNull(notificator.process(Status.ERROR,TimeUtils.toInstant("2017-09-19 13:13:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:14:00")));
    }
    ...
    public void severalStatuses() throws Exception{
        ...
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:04:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:05:00")));
        assertNull(notificator.process(Status.WARNING, TimeUtils.toInstant("2017-09-19 13:06:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:07:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:08:00")));
        assertNull(notificator.process(Status.WARNING, TimeUtils.toInstant("2017-09-19 13:09:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:10:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:11:00")));
        assertNull(notificator.process(Status.ERROR,   TimeUtils.toInstant("2017-09-19 13:12:00")));
        assertNotNull(notificator.process(Status.ERROR,TimeUtils.toInstant("2017-09-19 13:13:00")));
