...
public class TimeUtilsTest {
    ...
    public void stringWithUnitToSeconds(){
        Assert.assertEquals(3, TimeUtils.parsePeriod("3").get().getSeconds());
        Assert.assertEquals(23, TimeUtils.parsePeriod("23").get().getSeconds());
        Assert.assertEquals(34, TimeUtils.parsePeriod("34s").get().getSeconds());
        Assert.assertEquals(15 * 60, TimeUtils.parsePeriod("15m").get().getSeconds());
        Assert.assertEquals(2 * 60 * 60, TimeUtils.parsePeriod("2h").get().getSeconds());
    }
