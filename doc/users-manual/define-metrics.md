...
Operation can be configured using the "aggregate" parameter. Operation determines the variable type. 
...
metrics.define.tapeserverd-missing.variables.real_count.aggregate = count_floats
